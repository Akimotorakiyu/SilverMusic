...
对比反比例函数形式和指数形式，发现指数形式音律下产生的拍更接近和谐的直线,所以我们选择一个合理的简单的指数形式。（绿色线条为指数，紫色为反比例行形式）。
...
**计算上公式参数，对于10音律，叠置数为2-5个半音为较合适，其中2、5个半音可能由于拍相对较小或大，弱推荐使用**

**计算上公式参数，对于12音律，叠置数为2-5个半音为较合适，其中2、5个半音可能由于拍相对较小或大，弱推荐使用**

**计算上公式参数，对于14音律，叠置数为2-6个半音为较合适，其中2、6个半音可能由于拍相对较小或大，弱推荐使用**

**计算上公式参数，对于16音律，叠置数为2-6个半音为较合适，其中2、6个半音可能由于拍相对较小或大，弱推荐使用**
